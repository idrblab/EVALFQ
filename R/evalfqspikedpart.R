#' @title Conduct LFQ and assess performance for part of LFQ workflows by collectively considering the spiked proteins.
...
#' @importFrom graphics abline par segments stripchart text plot
#' @useDynLib EVALFQ
...
#' @import impute
#' @usage lfqspikepart(data_s, spiked, selectFile,
...
lfqspikepart <- function(data_s, spiked, selectFile, Ca="1", Cb="1", Cc="1", Cd="1", Ce="1"){
      ...
      for(o in  cen){
        ...
        for(p in  sca){
          ...
          for(j in nor){
            ...
            #train_data_filtering <-normalized_data
