...
#' @import impute
#' @usage lfqevalueall3(data_q, assum_a="Y", assum_b="Y",
#' assum_c="Y", Ca="1", Cb="1", Cc="1", Cd="1")
#' @export lfqevalueall3
#' @examples
#' library(EVALFQ)
...
#' \donttest{lfqevalueall3(data_q = data_q,
#' assum_a="Y", assum_b="Y", assum_c="Y", Ca="1", Cb="1", Cc="1", Cd="1")}


lfqevalueall3 <- function(data_q, assum_a="Y", assum_b="Y", assum_c="Y", Ca="1", Cb="1", Cc="1", Cd="1"){
          ...
          for(j in normalization){
            ...
            for(g in 1:8){
              ...
              if( Cd == 1 && length(label) >= 10 ){
                ...
                score <- try(stabel.score(repeats = 200, fold = 3, top = 50))
